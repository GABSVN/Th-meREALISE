...
if ( ! class_exists( 'themerealise_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 *
	 * @since REALISE_Theme 3000.1.0
	 */
	class themerealise_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'themerealise_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'themerealise_get_localized_font_family_elements',
				array(
			...
			return themerealise_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
