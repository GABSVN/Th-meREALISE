/* global themerealisebgcolors, themerealisePreviewEls, jQuery, _, wp */
/**
 ...
 ( function( $, api, _ ) {
	...
	api( 'accent_hue', function( value ) {
		value.bind( function() {
			...
			setTimeout( function() {
				Object.keys( themerealisebgcolors ).forEach( function( context ) {
					themerealiseGenerateColorA11yPreviewStyles( context );
				} );
			}, 50 );
		} );
	} );
	...
	Object.keys( themerealisebgcolors ).forEach( function( context ) {
		wp.customize( themerealisebgcolors[ context ].setting, function( value ) {
			value.bind( function() {
				// Generate the styles.
				// Add a small delay to be sure the accessible colors were generated.
				setTimeout( function() {
	 ...
	 * @return {void}
	 */
	function themerealiseGenerateColorA11yPreviewStyles( context ) {
		...
		if ( ! _.isUndefined( a11yColors[ context ] ) ) {
			...
			if ( themerealisePreviewEls[ context ] ) {
				_.each( themerealisePreviewEls[ context ], function( items, setting ) {
	...
	$( function() {
		themerealiseGenerateColorA11yPreviewStyles( 'content' );
		themerealiseGenerateColorA11yPreviewStyles( 'header-footer' );
	} );
