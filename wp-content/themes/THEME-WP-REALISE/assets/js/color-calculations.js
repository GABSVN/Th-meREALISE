 ...
 * @return {Object} - this
 */
 function _themerealisecolor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_themerealisecolor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_themerealisecolor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_themerealisecolor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _themerealisecolor object.
 *
 * @since REALISE_Theme 3000.1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function themerealisecolor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _themerealisecolor( backgroundColor, accentHue );
